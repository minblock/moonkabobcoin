...
{
    const char* pszTimestamp = "4/20/2020 Provigen Networks: Now powerd by transponderoshis!";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1585979329, 2427339, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x778329abd54476f178a09d2f63715d95aaf6fd5da3f4f8d448373c5b29133034"));
        assert(genesis.hashMerkleRoot == uint256S("0x305e1c46663847cd31113315fec2a4b70c51e9ba580ed39d8db29d536169a63e"));
        ...
        vSeeds.emplace_back("seed-a.moonkabobcoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.moonkabobcointools.com");
        vSeeds.emplace_back("dnsseed.moonkabobcoinpool.org");
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1486949366, 259874, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x88c17016c97a6949cb2ead4a87240418a619b7aa6e88899b9cd7e2c8dcb0e0ec"));
        assert(genesis.hashMerkleRoot == uint256S("0x305e1c46663847cd31113315fec2a4b70c51e9ba580ed39d8db29d536169a63e"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.emplace_back("testnet-seed.moonkabobcointools.com");
        vSeeds.emplace_back("seed-b.moonkabobcoin.loshan.co.uk");
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xa04898615546bc2fbc5545d60eb8a6f2be8f7ecbae680d28d5db9328dce29d5e"));
        assert(genesis.hashMerkleRoot == uint256S("0x305e1c46663847cd31113315fec2a4b70c51e9ba580ed39d8db29d536169a63e"));
