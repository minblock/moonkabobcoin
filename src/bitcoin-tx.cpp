...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " moonkabobcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  moonkabobcoin-tx [options] <hex-tx> [commands]  Update hex-encoded moonkabobcoin transaction\n" +
            "or:     moonkabobcoin-tx [options] -create [commands]   Create hex-encoded moonkabobcoin transaction\n" +
            "\n";
