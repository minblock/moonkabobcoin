# Support for Output Descriptors in Moonkabobcoin Core

Since Moonkabobcoin Core v0.17, there is support for Output Descriptors. This is a
...
on Moonkabobcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Moonkabobcoin Core wallets, a convenience function `combo` is
