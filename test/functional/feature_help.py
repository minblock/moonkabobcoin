...
"""Verify that starting moonkabobcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start moonkabobcoin with -h for help text")
        ...
        self.log.info("Start moonkabobcoin with -version for version information")
        ...
        self.log.info("Start moonkabobcoind with -fakearg to make sure it does not start")
